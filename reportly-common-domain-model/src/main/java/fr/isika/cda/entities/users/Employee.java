...
public class Employee extends UserAccount implements Serializable {
	...
	public Employee(String email, String password, double tjm, String name, String firstname, String adress,
			String city, String country, String postalCode, Date birthday, int phoneNumber, String jobTitle) {
